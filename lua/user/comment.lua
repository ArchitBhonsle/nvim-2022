...
vim.keymap.set(
  ...
  '<A-?>',
  function ()
  return vim.v.count == 0 and api.toggle_current_blockwise() or api.toggle_blockwise_count()
  end
)
...
vim.keymap.set(
  ...
  --   return api.toggle_linewise_op(vim.fn.visualmode())
  -- end
)
vim.keymap.set(
  'x',
  ...
  -- function () -- this does not work either :(
  --   return api.toggle_blockwise_op(vim.fn.visualmode())
  -- end
)
